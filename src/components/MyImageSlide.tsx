...
const ImageWrapper = styled.div`
    ...
    .image-container {
        ...
        align-items : center;
        flex-shrink: 0;
        transform : ${props => `translateX(-${props.theme.props.nowImage}%) scale(${props.theme.props?.animationScale})`};
...
const MyImageSlide = ({ setBannerColor, button = true, loading, interval = true, intervalTime = 2000, imageArray, draggable = true, keyDown = true, left = "◀︎", right = "▶"} : MyImageSlideProps) => {
